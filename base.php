...
//-----------------------------------------------------------------------------------------
//متغیر ها :
$Dev = array("139328010","348191491","00000000"); // ایدی ادمین ها را ماننده این الگورتیم بگذارید ادمین اصلی ایدی اول است
@$usernamebot = "VENICO_AlphaBoT"; // دقیق وارد کنید
@$channel = "VENICOSupport";
@$token = API_KEY;
//-----------------------------------------------------------------------------------------------
...
@$zakaria = $user["userjop"]["$from_id"]["file"];
